...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 28 Décembre 2017 à 00:09
...
(48, '2017-12-27 18:36:37', 'admin', 'Ceci est un commentaire 2                                       ', 27, 0);
...
CREATE TABLE `t_livre` (
  ...
  `livre_resume` varchar(100) NOT NULL,
  `livre_photo` varchar(100) NOT NULL DEFAULT 'livre-defaut.jpg'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `t_livre` (`livre_id`, `livre_titre`, `livre_resume`, `livre_photo`) VALUES
(1, 'Mon premier livre', 'Résumé de mon premier livre', 'livre-defaut.jpg'),
(2, 'Mon deuxième livre', 'Le résumé de mon deuxième livre', 'livre-defaut.jpg'),
(3, 'Jamais deux sans trois', 'Le résumé de mon troisième livre', 'livre-defaut.jpg');
...
INSERT INTO T_UTILISATEUR (`UTIL_ID`, `UTIL_LOGIN`, `UTIL_MDP`, `UTIL_NOM`, `UTIL_PRENOM`, `UTIL_DNAISSANCE`, `UTIL_EMAIL`, `UTIL_GRADE`, `UTIL_ACCES`) VALUES
(1, 'admin', '$2y$10$x8a6jWSMaCZjHxZJzsAHAenC9AkxZHxPbLFWPdNT/2x5No2FyajNC', 'admin', '', NULL, '', 'Administrateur', 'Autorise'),
(6, 'moderateur', '$2y$10$CW0x8qjXAzknihaFikpJqOwvUdytmbpUQabS6bPhvFvs851lXTW1.', 'moderateur', 'moderateur', '1980-12-01', 'modo@test.com', 'Moderateur', 'Autorise'),
(8, 'user', '$2y$10$QG/eIw/xrgx0h2BRdvqx7u/6IUJKurmcO89SPYPW0xvBXl3KxCdoi', 'utilisateur', 'utilisateur', '1980-12-01', 'user@test.com', 'Utilisateur', 'Autorise');
...
--
ALTER TABLE `t_livre`
  MODIFY `livre_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT pour la table `t_utilisateur`
--
ALTER TABLE T_UTILISATEUR
  MODIFY `UTIL_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
