                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group">
                                ...
                                <input type="text" name="dateNaissance" placeholder="Entrez votre date de naissance.." class="form-control">
                            </div>
                            <div class="col-sm-6 form-group">
                                <label>Email</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 form-group">
                                    ...
                                    <input type="password" name="mdp" placeholder="Entre votre mot de passe.." class="form-control">
                                </div>
                                <div class="col-sm-6 form-group">
                                    <label>Vérification du mot de passe</label>
                                    <input type="password" name="verif_mdp" placeholder="Retapez votre mot de passe.." class="form-control">
                                </div>
                            </div>

                            <button class="btn btn-lg btn-info" type="submit">Modifier l'utilisateur</button>
                        </div>
                </form>
