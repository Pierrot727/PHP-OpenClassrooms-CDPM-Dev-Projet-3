...
<head>
    ...
    <link rel='stylesheet' id='Roboto+Slab-css'
          href='http://fonts.googleapis.com/css?family=Roboto+Slab:1,300,400,400italic,700,700italic'>
    <link rel='stylesheet' id='Caudex-css'
          href='http://fonts.googleapis.com/css?family=Caudex:100,300,400,400italic,700,700italic'>
...
<footer>
        ...
        <div class="row link-zone">
            ...
            <div>
                ...
                <p> Un framework MVC par <a target="_blank" href="https://github.com/bpesquet/MonBlog">Baptiste Pesquet</a><br>
                    ...
                    Développeur <a target="_blank" href="http://tinymce.com">Pierre-Emmanuel Laporte</a></p>
            </div>
            <div>
    ...
    <div class="copyright">
        <div class="container">
            <p>&copy; 2018 Jean FORTEROCHE - Billet simple pour l'Alaska - Projet n° 3 - Chef de projet Dévellopement - OpenClassRooms - <a href="admin">Administraiton</a></p>
        </div>
    </div>
</footer>
